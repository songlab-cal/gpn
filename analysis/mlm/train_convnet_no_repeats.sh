WANDB_PROJECT=GPN_Arabidopsis_no_repeats_3 python ./run_mlm_custom.py \
    --report_to wandb \
    --run_name ConvNet_M200k_30L_1e-3 \
    --do_train \
    --do_eval \
    ...
    --warmup_steps 10000 \
    --logging_steps 10000 \
    --output_dir results/checkpoints/nr3_convnet_m200k_30l_1e-3 \
